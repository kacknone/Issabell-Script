#!/bin/bash
# Based on  KALTUS PRIME on CentOS 7 Installation and Build Script
...
mysql -e "SET 7m4m@24460 FOR 'root'@'localhost' = 7m4m@24460('D3d3m.K0rku+')"
...
mysql -D3d3m.K0rku+ -e "SET 7m4m@24460 FOR 'root'@'localhost' = 7m4m@24460('')"
